...
@NgModule({
  ...
  declarations: [SidebarLeftInnerComponent, HeaderComponent, SidebarRightInnerComponent, HeaderInnerComponent],
  exports: [BoxModule, TabsModule, SidebarLeftInnerComponent, HeaderComponent]
})
